...
enum Model{
	brockman = 'brockman-main',
	brockmanNC = 'brockman-main-nc',
	hvc = 'hvc-2040',
	hvcNC = 'hvc-2040-nc',
	pra = 'pra',
	rainbow = 'rainbow',
	rainbowNC = 'rainbow-nc',
}
const MAX_DISTANCE = 8000;
const TILE_FOLDER = Model.hvc;

class B3dmDracoApp {

  renderer = new WebGLRenderer({ antialias: true });
  scene = new Scene();
  camera = new PerspectiveCamera( 70,  window.innerWidth / window.innerHeight, 1, MAX_DISTANCE );
  controls: OrbitControls;

	tilesRenderer = new TilesRenderer( `/tiles/${TILE_FOLDER}/tileset.json` );
  ...
  constructor() {
    ...
    // Camera
    this.camera.position.set(0, MAX_DISTANCE, 0);
		// Controls
